...
class SpoolHNData implements ShouldQueue
{
  ...
  public function handle()
  {
    try {
      ...
      foreach ($stories as $storyId) {
        $existingStory = $storyId::where('id', $storyId)->first();
      ...
      Log::error('Error spooling data: ' . $e->getMessage());
  ...
  private function spoolStories()
  {
    try {
      ...
      return response()->json('Error spooling Stories: ' . $e->getMessage());
    }
  }
  ...
  private function spoolComments()
  {
    try {
      ...
      return response()->json('Error spooling Comments: ' . $e->getMessage());
    }
  }
  ...
  private function spoolAsks()
  {
    try {
      ...
      return response()->json('Error spooling Asks: ' . $e->getMessage());
    }
  }
  ...
  private function spoolJobs()
  {
    try {
      ...
      return response()->json('Error spooling Jobss: ' . $e->getMessage());
    }
  }
  ...
  private function spoolPolls()
  {
    try {
      ...
      return response()->json('Error spooling Polls: ' . $e->getMessage());
    }
  }
}